...
public final class Server extends Mod {
    ...
    public Server(String hostname, short serverID, OnlinePlayerTracker onlinePlayers, TrackyTrackyManager tracking) {
        super(Group.SERVERSIDE, "NServer", "", "");
