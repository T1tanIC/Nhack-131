...
public class Settings extends Mod {
	...
	public static String path = mc.gameDir.getPath() + "/nhack";
	public static File settings = new File(path + "/nhack.txt");
	
	/**
	 * Saves the settings from the GUI to a file located at .minecraft/nhack/Settings.txt
	 */
