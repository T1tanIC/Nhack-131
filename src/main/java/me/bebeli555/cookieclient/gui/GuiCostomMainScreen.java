...
public class GuiCustomMainScreen extends GuiScreen {
    private final String backgroundURL = "https://imgur.com/a/DPdfHnZ";
    ...
    public static boolean drawCompleteImage(float posX, float posY, float width, float height) {
        GL11.glPushMatrix();
    ...
    public static void drawCompleteImage(ResourceLocation resourceLocation) {
    }
