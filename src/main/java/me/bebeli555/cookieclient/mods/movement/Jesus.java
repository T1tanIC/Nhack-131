...
public class Jesus extends Mod {
    ...
    @EventHandler
    private final Listener<PlayerUpdateMoveStatePostEvent> onUpdateMoveState = new Listener<>(event -> {
    ...
    @EventHandler
    private final Listener<LiquidCollisionEvent> onLiquidCollision = new Listener<>(event -> {
