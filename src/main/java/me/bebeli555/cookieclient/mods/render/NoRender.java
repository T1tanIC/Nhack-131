...
public class NoRender extends Mod {
    ...
    @EventHandler
    private final Listener<GetRainStrenghtEvent> getRainStrenght = new Listener<>(event -> {
    ...
    @EventHandler
    private final Listener<RenderHurtcamEvent> onRenderHurtcam = new Listener<>(event -> {
    ...
    @EventHandler
    private final Listener<IsPotionEffectActiveEvent> isPotionActive = new Listener<>(event -> {
    ...
    @EventHandler
    private final Listener<PacketEvent> onPacket = new Listener<>(event -> {
    ...
    @EventHandler
    private final Listener<RenderUpdateLightMapEvent> onSkylightUpdate = new Listener<>(event -> {
    ...
    @EventHandler
    private final Listener<RenderSignEvent> onRenderSign = new Listener<>(event -> {
    ...
    @EventHandler
    private final Listener<RenderArmorLayerEvent> onRenderArmorLayer = new Listener<>(event -> {
    ...
    @EventHandler
    private final Listener<RenderMapEvent> onRenderMap = new Listener<>(event -> {
    ...
    @EventHandler
    private final Listener<RenderBossHealthEvent> onRenderBossHealth = new Listener<>(event -> {
