...
public class NameTags extends Mod {
	...
	private int count;
	private final HashMap<String, Integer> pops = new HashMap<String, Integer>();
    ...
    @EventHandler
    private final Listener<RenderEntityNameEvent> onRenderEntityName = new Listener<>(event -> {
        event.cancel();
    });
}
