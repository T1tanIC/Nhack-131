...
public class DiscordRPC extends Mod {
	...
	public boolean onEnabled() {
        ...
        presence.largeImageKey = "nhackimage";
        presence.largeImageText = "nhack is an utility client for anarchy servers. Github: https://github.com/@Pryrobite Discord: https://discord.gg/JPy2AYsU";
