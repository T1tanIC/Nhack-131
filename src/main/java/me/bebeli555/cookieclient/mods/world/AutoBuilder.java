...
public class AutoBuilder extends Mod {
	...
	private static final ArrayList<BuildPosition> positions = new ArrayList<BuildPosition>();
    ...
    @EventHandler
    private final Listener<PlayerUpdateEvent> onUpdate = new Listener<>(event -> {
