...
public class NoGlitchBlocks extends Mod {
    ...
    @EventHandler
    private final Listener<PlayerDestroyBlockEvent> onPlayerDestroyBlock = new Listener<>(event -> {
    ...
    @EventHandler
    private final Listener<ProcessRightClickBlockEvent> onRightClickBlock = new Listener<>(event -> {
